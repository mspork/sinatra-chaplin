...
(function() {
  ...
  define(['js/desktop/views/base/view', 'text!templates/desktop/hello-world.hbs'], function(View, template) {
    'use strict';
    ...
    return HelloWorldView = (function(_super) {
      ...
      HelloWorldView.prototype.autoAttach = true;

      HelloWorldView.prototype.id = 'hello';

      HelloWorldView.prototype.container = '#content-container';
